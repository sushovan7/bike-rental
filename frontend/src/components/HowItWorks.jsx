...
function HowItWorks() {
  return (
    <section className=" mt-32 flex flex-col items-center justify-center  mb-20 px-4 gap-3 py-16">
      <h1 className="text-2xl text-center font-bold mb-10">How it works</h1>
      <div className="flex flex-col md:flex-row   md:justify-between gap-20 items-center ">
        {howItWorksData &&
